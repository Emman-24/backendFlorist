        ...
        return if (existing != null) {
            ...
            if (existing.isCustom) {
                existing.apply {
                    ...
                    this.ogTitle = product.title
                    this.ogDescription = buildOgDescription(product)
                    this.ogImageUrl = imageUrl
            ...
            seoMetadataRepository.save(
                SeoMetadata(
                    ...
                    ogDescription = buildOgDescription(product),
                    ogImageUrl = imageUrl,
    ...
    fun setCustomMetadata(
        ...
        return if (existing != null) {
            ...
            existing.apply {
                ...
                keywords?.let { this.metaKeywords = it }
                ogTitle?.let { this.ogTitle = it }
                ogDescription?.let { this.ogDescription = it }
                this.isCustom = true
            ...
            seoMetadataRepository.save(
                SeoMetadata(
                    ...
                    ogTitle = ogTitle ?: product.title,
                    ogDescription = ogDescription ?: buildOgDescription(product),
                    ogImageUrl = imageUrl,
